                          ...
                          children: [
                            Stack(
                              children: [
                                ...
                                // ⭐ BADGE ONLY WHEN FAVORITES ARE PRESENT
                                ...
                                Stack(
                                  children: [
                                    IconButton(
                                      ...
                                      onPressed: () async {
                                        // 🛒 Go to Cart Page and wait for updated cart items
                                        final updatedCart = await Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => AddToCart(
                                              selectedItems:
                                                  cartItems, // ⭐ actual cart items pass करा
                                              totalPrice:
                                                  _cartTotalPrice, // ⭐ existing cart price
                                              similarMeals:
                                                  messes, // ⭐ similar meals list
                                            ),
                                          ),
                                        );
                                        // 🔥 If cart updated, update badge count
